    						...
    						<div class="card-body">
    							...
    							<div class="form-group">
    								...
    								<select name="id_pengadilan" class="form-control" required>
    									...
    									<option value="4">PA Tondano</option>
    									<option value="5">PA Bitung</option>
    									<option value="6">PA Amurang</option>
    									<option value="9">PA Boroko</option>
    									<option value="10">PA Tutuyan</option>
    									<option value="11">PA Bolaang uki</option>
    									<option value="12">PA Lolak</option>
    								</select>
    								<?php echo form_error('id_pengadilan') ?>
    							</div>
